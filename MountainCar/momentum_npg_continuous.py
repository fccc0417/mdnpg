...
def set_args(beta=0.2, seed=0):
    ...
    parser.add_argument('--lmbda', type=float, default=1, help='lambda for GAE')
    ...
    parser.add_argument('--actor_lr', type=float, default=3e-4, help='policy learning for initialization')
