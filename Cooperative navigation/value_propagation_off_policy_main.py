...
from value_propagation_one_step import ValuePropagation
...
def initialize_buffer(sample_env, agents, buffer_size, minimal_size=50, buffer_epoches=1000):
...
def run(args, env_name):
    ...
    replay_buffer = initialize_buffer(sample_env=env, agents=agents, buffer_size=args.buffer_size,
                                      minimal_size=args.minimal_size, buffer_epoches=args.buffer_epoches)
